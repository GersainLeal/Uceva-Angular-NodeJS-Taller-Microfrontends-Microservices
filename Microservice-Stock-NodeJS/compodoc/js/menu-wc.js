...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">Microservice Stock NodeJS</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/StockRoutes.html" data-type="entity-link" >StockRoutes</a>
                            </li>
                            <li class="link">
                                <a href="classes/StockService.html" data-type="entity-link" >StockService</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
